...
@CucumberOptions (
        features = "src\\test\\resources\\features\\firstFature.feature",
...
public class FirstRunner {
    ...
    //testNG ile çalıştırmak için class ın AbstractTestngCucumberTests isimli class extend edilmelidir.


    //Testng vs cucumber-junit
